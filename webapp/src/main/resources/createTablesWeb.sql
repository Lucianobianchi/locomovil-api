...
CREATE TABLE NEURAL_NETS_BSSIDS (
  NETWORK_ID SERIAL,
  BSSID VARCHAR(64),
  FOREIGN KEY (NETWORK_ID) REFERENCES NEURAL_NETS(NETWORK_ID) ON DELETE CASCADE,
  FOREIGN KEY (BSSID) REFERENCES WIFI_SCANS(BSSID) ON DELETE CASCADE,
  PRIMARY KEY (NETWORK_ID, BSSID)
);

CREATE TABLE NEURAL_NETS (
  NETWORK_ID SERIAL PRIMARY KEY,
  NETWORK_FILE VARCHAR(64),
  MAP_ID SERIAL,
